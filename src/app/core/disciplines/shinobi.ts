...
import { avoidBlow, climbing, silentWalk, meleeWeapons,
    ...
    maskTaint, poisonResistance, enhancedMatrixIllusionist,
    readandWriteIllusionism, spellcasting, sloughBlame, trueSight,
    hypnotize, multiThrow, vitalStrike, armoredMatrixIllusionist,
...
export const shinobi: Discipline = {
    ...
    talents: [
        ...
        new Talent(enhancedMatrixIllusionist, 9, false),
        ...
        new Talent(enhancedMatrixIllusionist, 11, false),
        new Talent(hypnotize, 11, false),
        new Talent(multiThrow, 12, true),
        new Talent(vitalStrike, 12, false),
        new Talent(armoredMatrixIllusionist, 13, false),
        new Talent(venom, 13, false),
        new Talent(armoredMatrixIllusionist, 14, false),
